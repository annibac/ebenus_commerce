...
public class AllProductsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userLogged == null)  {
            ...
            request.setAttribute("produits", servicefacade.getProduitDao().findAll());
            request.setAttribute("userLogged", userLogged);
            this.getServletContext().getRequestDispatcher("/pages/allProducts.jsp").forward(request, response);
        }
