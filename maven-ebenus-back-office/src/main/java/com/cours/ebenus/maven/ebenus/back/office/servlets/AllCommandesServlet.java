...
public class AllCommandesServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userLogged == null)  {
            ...
            request.setAttribute("commandes", servicefacade.getCommandeDao().findAll());
            request.setAttribute("userdao", servicefacade.getUtilisateurDao());
            request.setAttribute("userLogged", userLogged);
            this.getServletContext().getRequestDispatcher("/pages/allCommandes.jsp").forward(request, response);
        }
